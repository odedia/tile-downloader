  ...
  async function selectTASType(tasType) {
    ...
    try {
      ...
      const targetProducts = [
        ...
        { slug: 'tanzu-hub', name: 'Tanzu Hub', priority: 3 },
        { slug: 'tanzu-hub-collector', name: 'Platform Services (Hub Collector)', priority: 4 },
        { slug: 'p-rabbitmq', name: 'RabbitMQ', priority: 5 },
        { slug: 'pivotal-mysql', name: 'MySQL', priority: 6 },
        { slug: 'p-redis', name: 'Valkey', priority: 7 },
        { slug: 'tanzu-gemfire-for-vms', name: 'Gemfire', priority: 8 },
        { slug: 'apm', name: 'App Metrics', priority: 9 },
        { slug: 'p-metric-store', name: 'Metric Store', priority: 10 },
        { slug: 'pas-windows', name: 'Windows Add On', priority: 11 },
        { slug: 'pivotal_single_sign-on_service', name: 'Single Sign-On', priority: 12 },
        { slug: 'p-spring-cloud-services', name: 'Spring Cloud Services', priority: 13 },
        { slug: 'spring-cloud-gateway', name: 'Spring Cloud Gateway', priority: 14 },
        { slug: 'dataflow', name: 'Tanzu Data Flow', priority: 15 },
        { slug: 'stemcells-ubuntu-jammy', name: 'Stemcells (Ubuntu Jammy)', priority: 16 },
        { slug: 'credhub-service-broker', name: 'Credhub', priority: 17 },
        { slug: 'p-scheduler', name: 'Scheduler', priority: 18 },
      ];
